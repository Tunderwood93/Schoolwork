...
{ 
	...
	pthread_create(&threadID[0], NULL, (void *(*)(void *))consumeTen, &threadData[0]);
	pthread_create(&threadID[1], NULL, (void *(*)(void *))consumeTen, &threadData[1]);
	pthread_create(&threadID[2], NULL, (void *(*)(void *))consumeFifteen, &threadData[2]);
	pthread_create(&threadID[3], NULL, (void *(*)(void *))consumeFifteen, &threadData[3]);
