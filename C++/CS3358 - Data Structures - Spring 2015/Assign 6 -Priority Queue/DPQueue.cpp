...
namespace CS3358_Spring2015_Assign06
{
   ...
   p_queue::p_queue() : heap(new ItemType[5]), capacity(5), used(0)
   {
      //Initializer list used, body remains empty. 
   }
   ...
   void p_queue::pop()
   {
      ...
      heap[0].priority = heap[size() - 1].priority;
      used--; 
