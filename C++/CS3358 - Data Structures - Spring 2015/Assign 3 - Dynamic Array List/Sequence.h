// FILE: Sequence.h
// CLASS PROVIDED: sequence (part of the namespace CS3358_Sp15)
//
...
namespace CS3358_Sp15
{
   ...
   public:
      ...
      typedef std::size_t size_type; //Size_t is the result of the sizeof operator (This returns an unsigned int).. This makes size_type an int. 
